  ...
  themeConfig: {
    nav: [
      ...
      },
      {
        text: 'NPM包',
        items: [
          { text: 'eslint-config-norm', link: '/npm/eslint.md' },
      ...
      {
        text: '脚手架',
        items: [{ text: 'norm-fe-lint', link: '/cli/norm-fe-lint.md' }],
      },
    ],
    sidebar: [
      {
      ...
      },
      {
        title: 'NPM包',
        children: [
          { title: 'eslint-config-norm', path: '/npm/eslint.md' },
    ...
    extendFrontmatter: {
      author: {
        name: '冬瓜',
        link: 'https://github.com/qwe1550319804/styleGuide',
      },
    },
  },
