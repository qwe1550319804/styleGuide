...
describe('Validate JS configs', () => {
  it('Validate eslint-config-norm', async () => {
  ...
  it('Validate eslint-config-norm/es5', async () => {
  ...
  it('Validate eslint-config-norm/vue', async () => {
  ...
  it('Validate eslint-config-norm/essential', async () => {
  ...
  it('Validate eslint-config-norm/essential/es5', async () => {
  ...
  it('Validate eslint-config-norm/essential/react', async () => {
  ...
  it('Validate eslint-config-norm/essential/vue', async () => {
  ...
  it('Validate eslint-config-norm/node', async () => {
