...
describe('Validate TS configs', () => {
  it('Validate eslint-config-norm/typescript', async () => {
  ...
  it('Validate eslint-config-norm/typescript/vue', async () => {
  ...
  it('Validate eslint-config-norm/essential/typescript', async () => {
  ...
  it('Validate eslint-config-norm/essential/typescript/react', async () => {
  ...
  it('Validate eslint-config-norm/essential/typescript/vue', async () => {
  ...
  it('Validate eslint-config-norm/typescript/node', async () => {
